...
class _RegisterUserState extends State<RegisterUser> {
  ...
  //   docUrl = "https://images.rawpixel.com/image_png_800/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvcHUyMzMxNjM2LWltYWdlLTAxLXJtNTAzXzMtbDBqOXFrNnEucG5n.png" ;
  //   return true;
  // }
  Future<bool> uploadDocument() async {
    String url = "https://api.imgbb.com/1/upload";
    String apiKey = "361824ad4178bb830a3f367b9495380d";
    List<int> bytes = documentFile.bytes!;
    var req = {'key': apiKey, 'image': base64Encode(bytes)};
    if (docuName != "") {
      try {
        final response = await http.post(Uri.parse(url), body: req);
        if (response.statusCode == 200) {
          ...
          print('docUrl');
          showToast(
              "Successfully Created Account! Please Wait for verification.",
              context: context,
        ...
        print(e);
        showToast(e.toString(), context: context, backgroundColor: Colors.red);
      }
    } else {
